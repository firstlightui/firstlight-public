...
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scheme-light antialiased dark:scheme-dark">
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover">
        <meta name="description" content="{{ $description }}">
        <meta name="theme-color" content="#fbf7f2" media="(prefers-color-scheme: light)">
        <meta name="theme-color" content="#191410" media="(prefers-color-scheme: dark)">
    ...
    <body class="min-h-dvh bg-(--site-canvas) font-sans text-(--site-text)">
        ...
        <header class="relative z-50 border-b border-(--site-border) bg-(--site-canvas)/92 supports-backdrop-filter:bg-(--site-canvas)/80 supports-backdrop-filter:backdrop-blur-xl">
            <div class="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-4 lg:px-8">
                <a href="/" aria-label="Homepage" class="group flex min-w-0 items-baseline gap-2 rounded-sm focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-(--site-focus)">
                ...
                <nav aria-label="Primary navigation" class="hidden items-center gap-7 lg:flex">
                    <a href="#why-firstlight" class="text-sm font-medium text-(--site-muted) hover:text-(--site-heading) focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-(--site-focus)">Why Firstlight</a>
                    <a href="#components" class="text-sm font-medium text-(--site-muted) hover:text-(--site-heading) focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-(--site-focus)">Components</a>
                    <a href="#quickstart" class="text-sm font-medium text-(--site-muted) hover:text-(--site-heading) focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-(--site-focus)">Quickstart</a>
                ...
                <details class="group relative lg:hidden">
                    ...
                    <nav aria-label="Mobile navigation" class="absolute top-14 right-0 z-40 grid w-64 gap-1 rounded-(--radius-panel) bg-(--site-elevated) p-2 shadow-xl ring-1 ring-(--site-border) dark:shadow-none">
                        <a href="#why-firstlight" class="rounded-lg px-3 py-3 text-base font-medium text-(--site-muted) hover:bg-(--site-recessed) hover:text-(--site-heading) focus-visible:outline-2 focus-visible:outline-(--site-focus)">Why Firstlight</a>
                        <a href="#components" class="rounded-lg px-3 py-3 text-base font-medium text-(--site-muted) hover:bg-(--site-recessed) hover:text-(--site-heading) focus-visible:outline-2 focus-visible:outline-(--site-focus)">Components</a>
                        <a href="#quickstart" class="rounded-lg px-3 py-3 text-base font-medium text-(--site-muted) hover:bg-(--site-recessed) hover:text-(--site-heading) focus-visible:outline-2 focus-visible:outline-(--site-focus)">Quickstart</a>
        ...
        <footer class="border-t border-(--site-border)">
            <div class="mx-auto grid max-w-7xl gap-10 px-6 py-12 sm:grid-cols-2 lg:px-8">
                <div class="flex flex-col items-start gap-3">
                    <a href="/" aria-label="Homepage" class="font-semibold tracking-tight text-(--site-heading) focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-(--site-focus)">Firstlight UI</a>
                ...
                <nav aria-label="Footer navigation" class="flex flex-wrap items-start gap-x-7 gap-y-3 sm:justify-end">
                    <a href="#components" class="text-base font-normal text-(--site-muted) hover:text-(--site-heading) focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-(--site-focus) sm:text-sm">Components</a>
                    <a href="https://github.com/firstlightui/nativephp/tree/main/docs" class="text-base font-normal text-(--site-muted) hover:text-(--site-heading) focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-(--site-focus) sm:text-sm" target="_blank" rel="noreferrer">Documentation</a>
